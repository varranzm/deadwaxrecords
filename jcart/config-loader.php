...
if (!$config['text']['shipping']) $config['text']['shipping']		      = 'Shipping costs';
if (!$config['text']['total']) $config['text']['total']		              = 'Total';
if (!$config['text']['unreg']) $config['text']['unreg']          		  = 'Unregistered shipment';
if (!$config['text']['reg']) $config['text']['reg']          			  = 'Registered shipment'; 
if (!$config['text']['spain']) $config['text']['spain']          		  = 'Spain';  
if (!$config['text']['europe']) $config['text']['europe']         		  = 'Europe'; 
if (!$config['text']['row']) $config['text']['row']            			  = 'Rest of The World';    
if (!$config['text']['zonetitle']) $config['text']['zonetitle']      	  = 'Choose your location';    
if (!$config['text']['typeshipment']) $config['text']['typeshipment']     = 'Choose your shipping option';
