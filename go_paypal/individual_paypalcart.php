...
$paypal->set('business', 'orders@deadwaxrecords.es');
$paypal->set('currency_code', 'EUR');
$paypal->set('country', 'ES');
$paypal->set('return', 'http://www.deadwaxrecords.es/GoPayPal/index.php?api=individual_paypalcart');
$paypal->set('cancel_return', 'http://www.deadwaxrecords.es/GoPayPal/index.php?api=individual_paypalcart');
$paypal->set('notify_url', 'http://www.deadwaxrecords.es/GoPayPal/payment_complete.php'); # rm must be 2, need to be hosted online
